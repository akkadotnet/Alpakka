...
using Akka.Streams.Channels.Internal;
using Akka.Streams.Dsl;

namespace Akka.Streams.Channels
{
    /// <summary>
    /// Container class for Akka.Streams <see cref="Sink{TIn,TMat}"/> factory methods,
    /// which allow to integrate sinks with <see cref="ChannelWriter{T}"/> or expose akka streams
    /// graphs as <see cref="ChannelReader{T}"/>s.
    /// </summary>
