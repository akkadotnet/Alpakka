...
namespace Akka.Streams.Kafka.Dsl
{
    ...
    public static class KafkaProducer
    {
        ...
        /// </summary>
        public static Sink<ProduceMessage<TKey, TValue>, Task> PlainSink<TKey, TValue>(ProducerSettings<TKey, TValue> settings)
        {
        ...
        /// The `PlainSink` can be used for publishing records to Kafka topics.
        /// </summary>
        public static Sink<ProduceMessage<TKey, TValue>, Task> PlainSink<TKey, TValue>(ProducerSettings<TKey, TValue> settings, IProducer<TKey, TValue> producer)
        {
        ...
        /// </summary>
        public static Flow<ProduceMessage<TKey, TValue>, DeliveryReport<TKey, TValue>, Task> PlainFlow<TKey, TValue>(ProducerSettings<TKey, TValue> settings)
        {
        ...
        /// can for example be a <see cref="CommittedOffsets"/> that can be committed later in the flow.
        /// </summary>
        public static Flow<ProduceMessage<TKey, TValue>, Task<DeliveryReport<TKey, TValue>>, Task> TaskFlow<TKey, TValue>(ProducerSettings<TKey, TValue> settings)
        {
            var flow = Flow.FromGraph(new ProducerStage<TKey, TValue>(
                    settings,
                    closeProducerOnStop: true,
        ...
        /// </summary>
        public static Flow<ProduceMessage<TKey, TValue>, DeliveryReport<TKey, TValue>, Task> PlainFlow<TKey, TValue>(ProducerSettings<TKey, TValue> settings, IProducer<TKey, TValue> producer)
        {
            var flow = Flow.FromGraph(new ProducerStage<TKey, TValue>(
                    settings,
        ...
        /// can for example be a <see cref="CommitableOffset"/> that can be committed later in the flow.
        /// </summary>
        public static Flow<ProduceMessage<TKey, TValue>, Task<DeliveryReport<TKey, TValue>>, Task> TaskFlow<TKey, TValue>(ProducerSettings<TKey, TValue> settings, IProducer<TKey, TValue> producer)
        {
            var flow = Flow.FromGraph(new ProducerStage<TKey, TValue>(
                    settings,
                    closeProducerOnStop: false,
